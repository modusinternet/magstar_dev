...
<html lang="{CCMS_LIB:_default.php;FUNC:ccms_lng}">
	...
	<body>
		...
		<a href="/{CCMS_LIB:_default.php;FUNC:ccms_lng}/user/" class="logo_a" style="text-align:center;width:100%" title="Custodian CMS, for real website developers, not WYSIWYG developers.">
