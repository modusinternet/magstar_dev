...
(1, 1, 0, 'index', 'para1', 'ويقفز الثعلب البني السريع فوق الكلب الكسول.', '', 'Der schnelle braune Fuchs springt über den faulen Hund.', 'The quick brown fox jumped over the lazy dog.', 'El rápido zorro marrón salta sobre el perro perezoso.', 'Le brun rapide le renard saute sur le chien paresseux.', '', '', '速い茶色のキツネは怠け者の犬を跳び越えます。', '빠른 갈색 여우가 게으른 개 위로 뛰어 들었다.', '', '', 'De snelle bruine vos sprong over de luie hond heen.', '', '', 'Con cáo nâu nhanh nhẹn nhảy qua thân con chó lười.', '那只敏捷的棕毛狐狸跃过那只懒狗。', ''),
(2, 1, 0, 'index', 'para2', '', '', 'Wenn Zombies ankommen, schnell Richter Pat faxen.', 'When zombies arrive, quickly fax judge Pat.', 'Cuando llegan los zombis, de forma rápida Fax juzgar Pat.', 'Quand les zombies arrivent, faxent rapidement le juge Pat.', 'כאשר זומבים מגיעים, במהירו', '', 'ゾンビが到着するとき、速くパット裁判官にファクスで送ってください。', '좀비가 도착하면 Pat.', '', '', 'Als er zombies arriveren, fax dan snel rechter Pat.', '', '', 'Khi zombie đến, nhanh chóng fax thẩm phán Pat.', '僵尸到达时,快速传真法官英保通™技术。', ''),
(3, 1, 0, 'index', 'para3', 'كل بقرة جيدة، الثعلب، السنجاب، وحمار وحشي يحب القفز فوق الكلاب سعيدة.', '', 'Jede gute Kuh, Fuchs, Eichhörnchen, und Zebra mögen über glückliche Hunde springen.', 'Every good cow, fox, squirrel, and zebra likes to jump over happy dogs.', '', 'Chaque bonne vache, renard, l\'écureuil et le zèbre aiment sauter sur des chiens heureux.', '', '', 'すべての良い雌牛、キツネ、リスと、シマウマが幸せな犬を跳び越えることを好みます。', '', '', '', 'Elke goede koe, vos, eekhoorn en zebra springt graag over blije honden.', '', '', '', '每个好的母牛、狐狸、鼠笼式,和斑马喜欢跳过快乐狗。', ''),
(4, 1, 0, 'index', 'para4', '', '', 'Packen(Dichten) Sie meinen Kasten mit fünf Dutzend Alkohol-Krügen ein(ab).', 'Pack my box with five dozen liquor jugs.', 'Empacar mi caja con cinco jarras docena de bebidas alcohólicas.', 'Entassez ma boîte de cinq douzaines de cruches d\'alcool.', 'לארוז התיבה שלי עם חמישה קנקני תריסר משקאות.', '', '５ダースの酒水差しで私の箱を満たしてください。', '5 개의 주류 주전자로 상자를 포장하십시오.', '', '', 'Pak mijn doos in met vijf dozijn drankkannen.', '', '', 'Gói hộp của tôi với năm chục bình rượu.', '包我”框中有五个十几个酒瓶。', ''),
...
(7, 1, 0, 'page', 'title', '', '', 'Mehrsprachige Inhalt Beispiel - Seite # ', 'Multilingual Content Example - Page #', '', 'Exemple de contenu multilingue - Page n ° ', 'דוגמא תוכן רב לשוני - # עמוד', '', '多言語コンテンツ例 - ページ＃', '', '', '', 'Voorbeeld van meertalige inhoud - Pagina #', '', '', '', '多语种内容范例 - 页＃', ''),
...
(10, 1, 0, 'page', 'page-num', '', '', 'Seite #', 'Page #', '', 'Page n °', '# עמוד', '', 'ページ＃', '', '', '', 'Bladzijde #', '', '', '', '页＃', ''),
...
(48, 'Nederlands (Dutch)', 1, 'nl', 0, 'ltr', '');
(49, 'Nederlands (Dutch)', 0, 'nl-nl', 0, '', 'nl'),
(50, 'Português (Portuguese)', 1, 'pt', 0, 'ltr', ''),
(51, 'العربية (Arabic)', 1, 'ar', 0, 'rtl', ''),
(52, 'বাঙ্গালী (Bengali)', 1, 'bn', 0, 'ltr', ''),
(53, 'Pусский (Russian)', 0, 'ru', 0, 'ltr', ''),
(54, 'हिन्दी (Hindi)', 1, 'hi', 0, 'ltr', ''),
(55, '日本語 (Japanese)', 1, 'ja', 0, 'ltr', ''),
(56, '中国 (Chinese)', 0, 'zh', 0, '', 'zh-cn'),
(57, '中文 (Chinese, Simplified)', 1, 'zh-cn', 0, 'ltr', ''),
(58, '中文 (Chinese,Traditional)', 0, 'zh-tw', 0, '', 'zh-cn'),
(59, 'עברית (Hebrew)', 1, 'he', 0, 'rtl', ''),
(60, 'Norwegian (Bokmal)', 0, 'nb-no', 0, 'ltr', ''),
(61, '한국어 (Korean)', 1, 'ko', 0, 'ltr', ''),
(62, '한국어, 북한 (Korean, North)', 0, 'ko-kp', 0, '', 'ko'),
(63, '한국어, 한국 (Korean, South)', 0, 'ko-kr', 0, '', 'ko'),
(64, 'Tiếng Việt (Vietnamese)', 1, 'vi', 0, 'ltr', ''),
(65, 'المملكة العربية السعودية (Saudi Arabia)', 0, 'ar-sa', 0, '', 'ar');
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COMMENT='Records saved here contain details related to possible session highjacking attempts, when enabled in config.';
